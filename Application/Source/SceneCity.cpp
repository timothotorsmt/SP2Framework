...
void SceneCity::Update(double dt)
{
	...
	if (distanceFromCharacter1 < 20 && distanceFromCharacter2 > 40 && isDialogue == false && hasTalkedChar1 == false) {
		isDialogue = true;
		speech = Dialogue(1);
	}
	if (distanceFromCharacter2 < 20 && distanceFromCharacter1 > 40 && isDialogue == false && hasTalkedChar2 == false) {
		isDialogue = true;
		speech = Dialogue(6);
	}
	if (distanceFromCharacter2 < 20 && mouseToggle && Application::isMouseButtonPressed(0) && speech == D_CHAR_CHOICE) {
		mouseToggle = false;
	...
	if (distanceFromCharacter1 < 20 && mouseToggle && Application::isMouseButtonPressed(0) && speech == D_CHAR_CHOICE) {
		mouseToggle = false;
		if (42 < xpos && xpos < 58 && 7 < ypos && ypos < 13) {
	...
	if (distanceFromCharacter1 < 20 && mouseToggle && Application::isMouseButtonPressed(0) && isDialogue == true) {
		mouseToggle = false;
		if (speech == 6) {
	...
	if (distanceFromCharacter2 < 20 && mouseToggle && Application::isMouseButtonPressed(0) && isDialogue == true) {
		mouseToggle = false;
		if (speech == 11) {
			speech = D_CHAR_CHOICE;
		}
	...
	if (distanceFromCharacter1 > 20 && distanceFromCharacter2 > 20) {
		isDialogue = false;
	}
